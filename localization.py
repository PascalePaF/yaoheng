...
_EN: dict[str, str] = {
    ...
    "输入算式": "Enter an expression",
    "实时结果": "Live result",
    "公开市场参考汇率（非 C2C）": "Public market reference rates (non-C2C)",
    "复制结果": "Copy Result",
    "已复制": "Copied",
    "打开历史记录": "Open History",
...
_JA: dict[str, str] = {
    ...
    "输入算式": "式を入力", "实时结果": "リアルタイム結果", "公开市场参考汇率（非 C2C）": "公開市場の参考レート（C2Cではありません）",
    ...
    "立即退出曜衡": "曜衡を終了", "上一主题": "前のテーマ", "下一主题": "次のテーマ", "切换下一个主题": "次のテーマ",
